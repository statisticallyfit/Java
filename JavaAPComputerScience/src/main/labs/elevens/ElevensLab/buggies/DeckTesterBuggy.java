package labs.elevens.ElevensLab.buggies;

import labs.elevens.ElevensLab.Card;

/**
 * This is a class that tests the Deck class using assert statements.
 */
public class DeckTesterBuggy {
    ...
    private static void test1CardDeck() {
        ...
        String[] s1 = {"spades"};
        int[] v1 = {1};
        DeckBuggy5 d = new DeckBuggy5(r1, s1, v1);
    ...
    private static void test2CardDeck() {
        ...
        String[] s2 = {"hearts"};
        int[] v2 = {1, 2};
        DeckBuggy5 d = new DeckBuggy5(r2, s2, v2);
     ...
     */
    private static void testEmpty(DeckBuggy5 d) {
     ...
     */
    private static void testOneCard(DeckBuggy5 d, Card intended) {
        assert d.size() == 1 : "Size is " + d.size()
    ...
    private static void testShuffle() {
        ...
        DeckBuggy5 d1 = new DeckBuggy5(r, s, v);
        DeckBuggy5 d2 = new DeckBuggy5(r, s, v);
