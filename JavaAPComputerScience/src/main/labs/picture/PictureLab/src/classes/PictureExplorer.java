...
public class PictureExplorer implements MouseMotionListener, ActionListener, MouseListener
{
  ...
  {
      Picture pix = new Picture("myPictureOwl.jpg");
      pix.explore();

      Picture myPic = new Picture("myPictureOwl.jpg");
      Picture smallPic = myPic.scale(0.01, 0.01);
      smallPic.write("smallMyPictureOwl.jpg");
