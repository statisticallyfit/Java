package BookClasses.turtles;// <pre>
// Copy this file in its entirety to a file named Turtlet.java.
// Compile it before compiling the main.chapter1.Turtle.java file.
// You can put main.chapter1.Turtle commands inside the paint method of an applet if
...
{	public static final double DEGREE = Math.PI / 180; 
	...
	private double xcor, ycor;          // current position of main.chapter1.Turtle
	 ...
	 *  the drawing color is a property of thePage, not of one main.chapter1.Turtle. */
	...
	/** Write words without changing the main.chapter1.Turtle's state.  */
	...
	/** Make a circle of the given radius, main.chapter1.Turtle at center. */
	...
	/** Fill a circle of the given radius, main.chapter1.Turtle at center. */
...
// the main.chapter1.Turtle class, completed
	...
	/** Fill a rectangle of the given width and height, main.chapter1.Turtle at center. */
	 ...
	 *  so that an applet can pause an animation "between BookClasses". */
