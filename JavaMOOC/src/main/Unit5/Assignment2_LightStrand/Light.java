package main.Unit5.Assignment2_LightStrand;
...
public class Light {
    ...
    public Light(boolean o, boolean b, String c) {
        this.on = o;
        if(b) //if burnt out, it is not on
            on = false;
        this.burntOut = b;
        setColor(c);
    }
    ...
    public String toString() {
        ...
        if(burntOut)
            return glow + " " + color + "\tburnt out";
        else
            return glow + " " + color + "\tnot burnt out";
    }
    ...
    public void setColor(String c) {
        if(c.toLowerCase().equals("red")
                || c.toLowerCase().equals("green")
                || c.toLowerCase().equals("blue")){
            color = c.toLowerCase();
        } else {
            color = "white";
        }
