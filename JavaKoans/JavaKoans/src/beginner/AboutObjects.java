...
public class AboutObjects {
	...
	public void allClassesInheritFromObject() {
        ...
        assertEquals(ancestors[1], Bar.class);
        assertEquals(ancestors[2], Object.class);
        assertEquals(Foo.class.getName(), "beginner.AboutObjects$1Foo");
        assertEquals(Bar.class.getName(), "beginner.AboutObjects$1Bar");
        //assertEquals(Foo.class.getPackage().getName(), "beginner");
