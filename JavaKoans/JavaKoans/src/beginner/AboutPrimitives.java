...
public class AboutPrimitives {
	...
	public void shortsHaveASmallerRangeThanInts() {
		...
		assertEquals(Short.MAX_VALUE, (short)32767); //why explicit cast?
	}
	...
	public void bytesHaveASmallerRangeThanShorts() {
		...
		// todo Why would you use short or byte considering that you need to do explicit casts?
	}
	...
	public void charsCanOnlyBePositive() {
		...
		// todo Why did we cast MIN_VALUE and MAX_VALUE to int? Try it without the cast.

        /*
         * todo can also work like this: why did it need to be casted?
